...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Apartment Rental Dues</li>
        </ol>
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-table"></i> Apartment Rental Dues</div>
            ...
            <div class="modal-body">
                ...
                <form action="" method="post" role="form">
                    <div class="form-group">
                        <label>Date Due Posted</label>
                        <input type="date" class="form-control"
                        />
                    </div>
                    <div class="form-group">
                        <label>Nature of Due</label>
