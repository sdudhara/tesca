    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-table"></i> Discussion</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label>Thread Status</label><br>
                        <label class="radio-inline"><input type="radio" value="open" name="threadstatus" checked>Open</label>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label>Thread Status</label><br>
                        <label class="radio-inline"><input type="radio" value="open" name="threadstatus">Open</label>
                        <label class="radio-inline"><input type="radio" value="closed" name="threadstatus">Closed</label>
                        <label class="radio-inline"><input type="radio" value="reopen" name="threadstatus">Re-Open</label>
                    </div>
