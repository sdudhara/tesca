    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-table"></i> Notice</div>
            ...
            <div class="modal-body">
                ...
                <form action="" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <label class="radio-inline"><input type="radio" value="open" name="noticestatus" checked>Open</label>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label>Notice Status</label><br>
                        <label class="radio-inline"><input type="radio" value="open" name="noticestatus">Open</label>
                        <label class="radio-inline"><input type="radio" value="cancelled" name="noticestatus">Cancelled</label>
                        <label class="radio-inline"><input type="radio" value="fulfilled" name="noticestatus">Fulfilled</label>
                    </div>
