...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Rent History Report</li>
        </ol>
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-table"></i> Rent History Report</div>
            <div class="container"><br>

                <form role="form" action="reports/renthistrpt.php" method="post">
